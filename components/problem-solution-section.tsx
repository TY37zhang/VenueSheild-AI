            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-3xl mx-auto font-light leading-relaxed">
                        Traditional security monitoring can't keep up with large crowds. Here's how AI changes
                        everything.
                    </p>
                </div>
                ...
                >
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-white/70 mb-6 sm:mb-8 max-w-2xl mx-auto font-light leading-relaxed">
                        Get a free safety assessment and see how VenueShield AI can transform your venue's security
                        posture.
                    </p>
                    <Button
                        size="lg"
