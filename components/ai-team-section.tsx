      ...
      <div className="bg-white rounded-b-[3rem] pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Watch how VenueShield AI detects risks, provides recommendations, and helps operators respond in
              real-time.
            </p>
          </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:h-[600px] space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                ...
                <div className="space-y-3 lg:space-y-4 text-base lg:text-lg text-slate-700 leading-relaxed">
                  <p>
                    While your team focuses on guests, VenueShield AI monitors every camera feed, detecting crowd
                    surges, disturbances, and compliance issues in real-time.
                  </p>

                  <p>
                    Every alert you're watching could be preventing an injury, avoiding a lawsuit, or ensuring
              ...
              >
                <div className="p-4 lg:p-6 bg-slate-50 rounded-xl border-l-4 border-slate-900">
                  <p className="text-slate-800 font-medium text-sm lg:text-base">
                    "VenueShield detected a crowd surge 8 minutes before it would have become dangerous. We prevented
                      ...
                      <div className="bg-white rounded-[1.5rem] overflow-hidden">
                        ...
                        <div className="bg-slate-50 px-6 py-3 flex justify-between items-center text-sm">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-medium text-slate-700">VenueShield AI</span>
                          </div>
                        ...
                        <div className="p-4 bg-white border-t border-slate-200">
                          <div className="flex items-center gap-3 bg-slate-100 rounded-full px-4 py-2">
                            <span className="text-slate-500 text-sm lg:text-base flex-1">AI is analyzing feeds...</span>
