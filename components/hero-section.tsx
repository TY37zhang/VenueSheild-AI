      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6 animate-fade-in-heading">
          ...
          <span className="inline-flex items-center justify-center gap-2 mt-4 sm:mt-6 md:mt-8 whitespace-nowrap">
            ...
            <RotatingText
              texts={["AI Safety", "Real-Time Alerts", "Smart Analytics", "Risk Detection", "Compliance"]}
        ...
        <p className="text-base sm:text-xl md:text-2xl text-white text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          VenueShield AI detects safety risks in real-time using your existing cameras. Prevent incidents, respond
          faster, and build visitor confidence.
        </p>
        ...
        <div className="text-center px-4 hidden sm:block overflow-hidden animate-fade-in-trust">
          <p className="text-sm text-white mb-6">Trusted by leading venues worldwide</p>
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">Sports Arenas</div>
                <div className="text-base sm:text-lg font-semibold">Theaters</div>
                <div className="text-base sm:text-lg font-semibold">Convention Centers</div>
                <div className="text-base sm:text-lg font-semibold">Universities</div>
                <div className="text-base sm:text-lg font-semibold">Nightclubs</div>
                <div className="text-base sm:text-lg font-semibold">Stadiums</div>
              </div>
